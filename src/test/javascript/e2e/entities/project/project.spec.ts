...
describe('Project e2e test', () => {
  ...
  it('should load Projects', async () => {
    ...
    expect(await projectComponentsPage.getTitle()).to.eq('totoApp.project.home.title');
  ...
  it('should load create Project page', async () => {
    ...
    expect(await projectUpdatePage.getPageTitle()).to.eq('totoApp.project.home.createOrEditLabel');
  ...
  it('should delete last Project', async () => {
    ...
    expect(await projectDeleteDialog.getDialogTitle()).to.eq('totoApp.project.delete.question');
