...
describe('Label e2e test', () => {
  ...
  it('should load Labels', async () => {
    ...
    expect(await labelComponentsPage.getTitle()).to.eq('totoApp.label.home.title');
  ...
  it('should load create Label page', async () => {
    ...
    expect(await labelUpdatePage.getPageTitle()).to.eq('totoApp.label.home.createOrEditLabel');
  ...
  it('should delete last Label', async () => {
    ...
    expect(await labelDeleteDialog.getDialogTitle()).to.eq('totoApp.label.delete.question');
