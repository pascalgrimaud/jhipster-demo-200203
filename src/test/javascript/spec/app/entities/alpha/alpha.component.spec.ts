...
import { AlphaComponent } from 'app/entities/alpha/alpha.component';
import { AlphaService } from 'app/entities/alpha/alpha.service';
import { Alpha } from 'app/shared/model/alpha.model';

describe('Component Tests', () => {
  describe('Alpha Management Component', () => {
    let comp: AlphaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AlphaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.alphas && comp.alphas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
